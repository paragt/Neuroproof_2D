...
void StackLearn::generate_edge_classifier_features(double threshold, UniqueRowFeature_Label& all_featuresu){


    /*C* no inclusion removal for 2D
...
void StackLearn::fit_edge_classifier(double threshold, UniqueRowFeature_Label& all_featuresu, const char* clfr_filename){
...
void StackLearn::generate_edge_classifier_features_queue(double threshold, UniqueRowFeature_Label& all_featuresu ){
...
//     printf("done with %d regions\n",get_num_bodies());	
    ...
    printf("agglo done with %d regions\n", get_num_bodies());	
/*
    std::vector< std::vector<double> >	all_features;
    all_featuresu.get_feature_label(all_features, all_labels);	
